...
const materials = [
  ...
  { category: "영적 분별 · 1~5과", title: "분별에서 사랑으로", description: "외적인 현상과 잘못된 잣대에서 자유로워져 정죄가 아닌 사랑으로 나아가는 영적 분별 성경공부입니다.", href: "/bible-study/discernment-to-love#study-content", status: "1~5과 성경공부 열기" },
